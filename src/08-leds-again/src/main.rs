...
pub fn main() -> ! {
    ...
    //
    // rcc.ahbenr.write(|w| w.iopaen(true).iopcen(true));
    //
    // /// PA5
    // gpioa.moder.write(|w| w.moder5(1));
    //
    // // PC13
    // gpioc.moder.write(|w| w.moder13(0));
    //
    // gpioa.odr.write(|w| w.odr5(false));
    //
    // loop {
    //     let val = gpioc.idr.read().idr13();
    //     gpioa.odr.write(|w| w.odr5(val));
    // }
}
